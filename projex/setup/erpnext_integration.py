	...
	create_custom_fields(
		{
			"Projex Project": [
				...
				},
				{
					...
					"description": "Total engagement value; milestone billing percent is applied to this",
				},
				{
				...
				{
					"fieldname": "billing_rates",
					"label": "T&M rate card",
					"fieldtype": "Table",
					"options": "Projex Billing Rate",
					"insert_after": "billing_currency",
					"description": "Hourly rates per delivery role for Time & Materials billing",
				},
			]
		},
